            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="row mb-3">
                            <label for="age" class="col-md-4 col-form-label text-md-end">DOB</label>

                            <div class="col-md-6">

                                <input id="age"  type="date" class="form-control @error('age') is-invalid @enderror" name="age" value="{{ old('age') }}" required max="{{ date('Y-m-d', strtotime('-18 years')) }}"  >
                        ...
                        <div class="row mb-3">
                            <label for="gender" class="col-md-4 col-form-label text-md-end">Password</label>
